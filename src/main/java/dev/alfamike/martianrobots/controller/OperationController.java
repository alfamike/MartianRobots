					...
					if (fcoo == null) {
						...
						if (coResult.getxAxis() > input.getGridX() - 1 || coResult.getxAxis() < 0
							...
							message = aux.getxAxis() + "\t" + aux.getyAxis() + "\t" + aux.getOrientation().toString()
									+ "\t" + "LOST";
							message2 = aux.getxAxis() + " " + aux.getyAxis() + " " + aux.getOrientation().toString()
									+ " " + "LOST";
							...
							// Log
							LogMovements log = new LogMovements(robot.getId(), robot.getxPosition(),
									robot.getyPosition(), robot.getOrientation());
							repoLog.save(log);
							...
							// Log
							LogMovements log2 = new LogMovements(robot.getId(), robot.getxPosition(),
									robot.getyPosition(), robot.getOrientation());
							repoLog.save(log2);
							...
							// Print to cmd
							message = coResult.getxAxis() + "\t" + coResult.getyAxis() + "\t"
									+ coResult.getOrientation().toString();
							message2 = coResult.getxAxis() + " " + coResult.getyAxis() + " "
									+ coResult.getOrientation().toString();
						}
					} else {
